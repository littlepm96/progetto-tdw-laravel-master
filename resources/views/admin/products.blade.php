            ...
            <div class="col-md-4 col-lg-3">
                <div class="card card-cascade narrower hm-zoom">
                    <div class="view overlay hm-white-slight">
                        <img src="{{asset('../storage/app/public/'.$product->image)}}" class="img-fluid"
                             alt="{{__('admin_pages.no_choosed_image')}}">
                        <a>
                            <div class="mask"></div>
                        </a>
                    </div>
                    <div class="card-body text-center no-padding">
                        ...
                        <a href="?edit={{$product->id}}"
                           class="btn btn-sm btn-secondary waves-effect waves-light">{{__('admin_pages.edit_user')}}</a>
                        <a href="{{ lang_url('admin/delete/product/'.$product->id) }}"
                           data-my-message="{{__('admin_pages.are_u_sure_delete')}}"
                           class="btn btn-secondary btn-sm confirm">
