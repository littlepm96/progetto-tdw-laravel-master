...
<div class="wrapper">
        ...
        <div class="container">
            <div class="navbar-header">
                <a href="{{ lang_url('/home') }}" class="logo" title="">
                    <img src="../public/img/logo2.png" alt="Craft Beer HTML Template">
                </a>
    ...
    <div id="hero" class="single-page section"
         style="background-image: url('../progetto-tdw-laravel-master/images/copertina_4.jpg')">
