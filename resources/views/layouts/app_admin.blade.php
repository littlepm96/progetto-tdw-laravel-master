                ...
                <div class="col-sm-9 col-md-9 col-lg-10 col-sm-offset-3 col-md-offset-3 col-lg-offset-2 right-side">
                    <nav class="navbar">
                        ...
                        <div id="navbar" class="collapse navbar-collapse">
                            ...
                            <form class="navbar-form navbar-right nav-bar-search"
                                  action="{{lang_url('admin/products')}}" role="search">
                                <div class="form-group is-empty waves-light waves-effect waves-light">
                                    <input class="form-control" placeholder="{{ __('admin_pages.search_product') }}"
                                           value="{{ Request::get('search') }}" name="search" type="text">
                    ...
                    <button type="button"
                            class="btn purple-gradient btn-sm menu-btn-xs">{{__('admin_pages.show_mine_menu')}}</button>
