                                ...
                                <div class="container">
                                    <div class="row">
                                        <div class="col-sm-5 matchHeight">
                                            <img src="../storage/app/public/images/UOfTm3hmPchJhG5ETsaT3h6gjxJyjtZcr2UVMbSh.jpeg"
                                                 alt="About our Brewery" class="alignMiddle"/>
                                        </div>
                                        <div class="col-sm-6 col-sm-push-1 matchHeight">
                                            <section class="alignMiddle mobile-center">
                                                ...
                                                <a href="{{$product->url}}"
                                                   class="btn btn-default"><span>Go to shop</span></a>
                                            </section>
                                        </div>
                                    </div>
                                </div>
