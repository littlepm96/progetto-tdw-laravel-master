			...
			<div class="row">
				...
				<div class="col-sm-6 col-sm-push-1 matchHeight">
					<section class="alignMiddle mobile-center">
						...
						<h4><input class="quantity"  name="quantity" type="text" placeholder="Quantity">
							<a href="javascript:void(0);" class="buy-now to-cart"  data-product-id="{{$product->id}}" >
								<span>Add to cart</span></a></h4>
					</section>
				</div>
			</div>
		</div>
